(function(){
	...
	var homeSectionItems = [
		...
		},
		{
			...
			'<p>This translates to following end user benefits:<li>easier to adopt strong password because user does not have to remember 10s of different passwords</il>'+
